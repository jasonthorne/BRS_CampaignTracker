...
public class PairingOLD {
	...
	//constructor:
	public PairingOLD(String player1, String player2) { //+++++++++++++++Should check that this is of size 2, and throw if not!! 
		/*player1 = list.poll();
		player2 = list.poll();*/
	...
	public boolean equals(Object obj) {
		 if (!(obj instanceof PairingOLD))
		        return false;
		 PairingOLD ref = (PairingOLD) obj;
	...
	public String toString() {
		return "PairingOLD [player1=" + player1 + ", player2=" + player2 + "]";
	}
